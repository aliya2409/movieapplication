...
<c:set var="jspName" value="/movieInfo?movieId=${movie.id}" scope="request"/>
<c:choose>
    ...
    <div class="col-8">
        ...
        <div class="card">
            <div class="row no-gutters">
                <div class="col-auto">
                    <img class="img-fluid" src="data:image/jpg;base64,<c:out value='${movie.imageBase64}'/>" alt="">
                </div>
                <div class="col">
                    <div class="card-block px-2">
                        ...
                        <c:if test="${movie.translatedTitle ne movie.originalTitle and not empty movie.translatedTitle}">
                            <p
                                    class="card-text">${movie.originalTitle}</p></c:if>
                        <p class="card-text"><strong><fmt:message
                                key="releaseDate"/>: </strong>${movie.formattedReleaseDate}
                        </p>
                        <p class="card-text"><strong><fmt:message key="budget"/>: </strong>$ ${movie.formattedBudget}
                        </p>
                        ...
                        <p class="card-text"><strong><fmt:message key="description"/>: </strong>${movie.description}</p>
                        <p>
                        ...
                        <c:choose>
                            <c:when test="${not empty sessionScope.user and user.roleId eq 2}">
                                <p>
                                <div class="btn-group">
                                    ...
                                    <a href="${movieServlet}/deleteMovie?movieId=${movie.id}" class="btn btn-danger"
                                       roleId="button"><fmt:message
                                            key="deleteMovie"/></a>
                                </div>
                                </p>
                                <div class="collapse" id="buttoncollapseUpdate">
                                    <div class="form-group">
                                        <form action="${movieServlet}/updateMovie" method="post"
                                            ...
                                            <input name="budget" class="form-control" id="budget" type="number"
                                                   required/>
                                            <label for="datepicker"><fmt:message key="releaseDate"/></label>
                                            <input type="text" class="form-control" name="releaseDate" id="datepicker"
                                                   required/>
                                ...
                                <div class="collapse" id="buttoncollapseAdd">
                                    <form action="${movieServlet}/addMovieGenre" name="genreAdd">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nameAdd" name="name" value=""
                                                   required>
                                        </div>
                                        <button type="submit" class="btn btn-primary"><fmt:message
                                                key="submit"/></button>
